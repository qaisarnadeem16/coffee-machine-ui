...
const Viewer3D = () => {
	...
	return (
		<ViewerContainer ref={ref}>
			{!isSceneLoading && <ZakekeViewer bgColor='#f2f2f2' className='rounded-2xl' />}

			{!isInfoPointContentVisible &&  (
			<div className="bg-white max-w-12 p-5 py-4 items-center justify-center flex flex-col gap-5 lg:gap-7 absolute left-[7%] md:top-1/3 top-[10%] rounded-full">
